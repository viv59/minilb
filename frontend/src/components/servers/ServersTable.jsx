        ...
        >
            <table className="w-full border-collapse text-[12.5px]">
                ...
                <tbody>
                    {filtered.map((s) => (
                        <tr key={s.id}>
                            <td className="border-b border-app-text/5 px-2 py-3">
                                {s.id}
                            </td>
                            <td className="border-b border-app-text/5 px-2 py-3">
                                {s.name}
                            </td>
                            <td className="border-b border-app-text/5 px-2 py-3 text-status-green">
                                ● {s.status}
                            </td>
                            <td className="border-b border-app-text/5 px-2 py-3">
                                {s.ip}
...
function Bar({ pct }) {
    return (
        <span className="inline-flex items-center gap-2">
            <span className="h-1.5 w-16 overflow-hidden rounded-full bg-app-text/10">
                <span
